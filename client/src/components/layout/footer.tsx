    ...
    <>
      ...
      <div className="w-full px-5 sm:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:hidden text-left mb-10">
          <div className="flex flex-col items-start">
            ...
            <nav className="flex flex-col gap-3 text-base text-white/70">
              <Link href="/" className="hover:text-white transition-colors py-1 block w-full">Inicio</Link>
              <Link href="/servicios" className="hover:text-white transition-colors py-1 block w-full">Nuestros Servicios</Link>
              <button onClick={() => handleHashClick('/servicios#pricing')} className="hover:text-white transition-colors py-1 block w-full text-left">Precios</button>
              <Link href="/faq" className="hover:text-white transition-colors py-1 block w-full text-left">FAQ</Link>
            </nav>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <nav className="flex flex-col gap-3 text-base text-white/70">
              <Link href="/legal/terminos" className="hover:text-white transition-colors py-1 block w-full">Términos</Link>
              <Link href="/legal/privacidad" className="hover:text-white transition-colors py-1 block w-full">Privacidad</Link>
              <Link href="/legal/reembolsos" className="hover:text-white transition-colors py-1 block w-full">Reembolsos</Link>
              <Link href="/legal/cookies" className="hover:text-white transition-colors py-1 block w-full">Cookies</Link>
            </nav>
          </div>
        </div>
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-10 text-left">
          ...
          <div className="flex flex-col items-start">
            ...
            <nav className="flex flex-col gap-3 text-base text-white/70">
              ...
              <Link href="/servicios" className="hover:text-white transition-colors">Nuestros Servicios</Link>
              <button onClick={() => handleHashClick('/servicios#pricing')} className="hover:text-white transition-colors text-left">Precios</button>
              <Link href="/faq" className="hover:text-white transition-colors text-left">FAQ</Link>
            </nav>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <nav className="flex flex-col gap-3 text-base text-white/70">
              ...
              <Link href="/legal/reembolsos" className="hover:text-white transition-colors">Política de Reembolsos</Link>
              <Link href="/legal/cookies" className="hover:text-white transition-colors">Aviso de Cookies</Link>
            </nav>
          </div>
        ...
        <div className="mt-10 sm:mt-14 pt-8 border-t border-white/20">
          <p className="text-center text-white/50 text-sm font-black  tracking-widest mb-6">Partners</p>
