...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-[100] bg-brand-lime border-b border-brand-dark/10 shadow-md transition-shadow h-20 sm:h-24 flex items-center" data-mobile-menu-open={isOpen}>
      ...
      {isOpen && (
        <div className="md:hidden fixed inset-0 bg-brand-lime z-[60] overflow-y-auto flex flex-col pt-16 sm:pt-24">
          <div className="flex flex-col flex-grow bg-brand-lime p-6 justify-start pt-8">
            <div className="flex flex-col gap-0.5">
              <button
                onClick={() => handleNavClick("/")}
                className="text-left px-3 py-3 rounded-xl text-brand-dark hover:bg-white/20 transition-colors font-black text-xl uppercase tracking-tighter border border-transparent hover:border-brand-dark/20"
              ...
              <button
                ...
                className="text-left px-3 py-3 rounded-xl text-brand-dark hover:bg-white/20 transition-colors font-black text-xl uppercase tracking-tighter border border-transparent hover:border-brand-dark/20 mb-4"
              ...
              <div className="mt-8 px-3 flex flex-col gap-3">
                <Button 
                  onClick={() => handleNavClick("/servicios")}
                  className="w-full bg-brand-dark text-white font-black border-0 rounded-full h-12 text-base shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2"
