      ...
      <main className="pt-24 pb-16 w-full max-w-4xl mx-auto px-4 md:px-6">
        ...
        >
          <div className="text-center mb-10">
            <h3 className="text-xl md:text-3xl font-black text-primary uppercase tracking-tight mb-1">Otras vías de contacto</h3>
            <p className="text-accent font-black uppercase tracking-wide text-sm md:text-base">(Escríbenos, te esperamos!)</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <a 
              ...
              className="flex items-center justify-center gap-6 p-8 rounded-[2rem] bg-[#25D366]/10 border border-[#25D366]/30 hover:bg-[#25D366]/20 transition-all group"
            >
