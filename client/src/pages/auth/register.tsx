                  ...
                  <div key="step-5" className="space-y-4">
                    ...
                    <div className="p-4 bg-accent/5 border border-accent/20 rounded-2xl" data-testid="section-language-selector">
                      <div className="flex items-center gap-2 mb-3">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-accent" data-testid="icon-language-globe">
                          ...
                          <path d="M5 8C7.5 9.5 16.5 9.5 19 8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/>
                          <path d="M5 16C7.5 14.5 16.5 14.5 19 16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/>
                        </svg>
