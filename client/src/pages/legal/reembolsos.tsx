  ...
  return (
    <div className="min-h-screen font-sans bg-white">
      ...
      <div className="container max-w-4xl mx-auto py-16 px-5 sm:px-8">
        <p className="mb-4 text-muted-foreground leading-relaxed">Nuestra política de reembolsos garantiza la satisfacción del cliente según los términos establecidos durante la contratación.</p>
      </div>
